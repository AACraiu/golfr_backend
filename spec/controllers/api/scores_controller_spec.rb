...
describe Api::ScoresController, type: :controller do
  ...
  describe 'POST create' do
    it 'should save and return the new score if valid parameters' do
      ...
      post :create, params: { score: { total_score: 79, played_at: '2021-06-29' }}
    ...
    it 'should return a validation error if score is played in the future' do
      ...
      post :create, params: { score: { total_score: 79, played_at: '2090-06-29' }}
    ...
    it 'should return a validation error if score value is too low' do
      ...
      post :create, params: { score: { total_score: 10, played_at: '2021-06-29' }}
